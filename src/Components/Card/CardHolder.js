...
const CardHolder = () => {
    ...
    return (
        <div style={{  display: "flex", justifyContent:"space-around", margin:"1rem 1rem 0 1rem", flexWrap:"wrap", backgroundColor:"black" }} >
            <ActionAreaCard onClick={showModal} id='projects' toDisplay="Projects" toDescribe="Few Projects I've done last year with everything I have learnt along the journey." todo="projects" source="https://serving.photos.photobox.com/902361465e1bbc2538d9bace84e77ae1d4903eb68afd60bfe96354889ea4cd99d41f1fd3.jpg" />
