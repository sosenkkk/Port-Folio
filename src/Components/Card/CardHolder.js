...
const CardHolder = () => {
    ...
    return (
        <div style={{  display: "flex", justifyContent:"space-around", flexWrap:"wrap", backgroundColor:"black" }} >
            ...
            <ActionAreaCard onClick={showModal} id='achievements' toDisplay="Achievements" toDescribe="Here are a few things I've achieved." todo="achieve" source="https://i.pinimg.com/originals/a6/53/12/a653125902cbc01ad4f1198d33aadfc6.gif" />
