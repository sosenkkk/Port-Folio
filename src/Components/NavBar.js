...
const icons = [<a className={styles.link_navbar} href='https://github.com/sosenkkk' ><GitHubIcon /></a>,<a className={styles.link_navbar} href="https://www.linkedin.com/in/shashank-raj-5bb2a11b6/"><LinkedInIcon /></a>]
